package com.example.securityApp.securityApplicationo.config;

import com.example.securityApp.securityApplicationo.entities.enums.Permission;
import com.example.securityApp.securityApplicationo.filter.JwtAuthFilter;
...
import static com.example.securityApp.securityApplicationo.entities.enums.Permission.*;
...
//                .withUsername("admin")
//                .password(passwordEncoder().encode("adming"))
//                .roles("ADMIN")
//                .build();
//
